...
<body>
    ...
    <section class="panel"> <!--Functionality to delete a handler-->
        <h1 class="titre_section"> Tableau de gestion des permissions des gestionnaires :</h1>
        <div class="grid">
            <?php foreach($resultat as $nom_gestionnaire){ ?>
                <div class="bloc">
                    ...
                    <form method="post" action="">
                        ...
                        <input type="submit" name="suppression" value="Enlevez">
                        <input type="submit" name="ajout" value="Remettre">
                    </form>
                </div>
            <?php } ?>
        </div>
