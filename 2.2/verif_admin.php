<?php
    ...
    if(isset($_POST['suppression'])) {
        ...
        $resultat = mysqli_query($id_bd, "UPDATE gestionnaire SET permission = 0 WHERE login = '$nom_gestionnaire';");
     ...
     if(isset($_POST['ajout'])) {
        $nom_gestionnaire = $_POST['login'];
        $resultat = mysqli_query($id_bd, "UPDATE gestionnaire SET permission = 1 WHERE login = '$nom_gestionnaire';");
        header("Location: menu_admin.php");
        exit();
    }
